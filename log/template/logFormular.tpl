        ...
        <form action="log.php?action=saveTrade" method="post" enctype="multipart/form-data" class="form-section">
			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					...
					<input type="hidden" name="id" value="{$coins['id']|default:''}"> <!-- Verstecktes Feld für die ID -->
				</div>
			...
			<div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="date" class="form-control" id="datum" name="datum" value="{$currentDate|default:''}">
                </div>
                <div class="form-group col-md-6">
                    <label for="uhrzeit">Uhrzeit</label>
                    <input type="time" class="form-control" id="uhrzeit" name="uhrzeit"  value="{$currentTime|default:''}">
                </div>
            </div>
            ...
            <div class="form-row">
				<div class="form-group col-md-6">
					...
					<select class="form-control" id="coin" name="coin">
						...
						{foreach $pdcoins as $pdcoin}
						<option value="{$pdcoin.id}" {if $selectedCoinId == $pdcoin.id}selected{/if}>{$pdcoin.coin}</option>			
						{/foreach}
					</select>
				</div>
				...
				<div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="ziel_guv" name="ziel_guv" value="{$coins['ziel_guv']|default:''}">
                </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="account" name="account" value="{$coins['account']|default:''}">
                </div>
                <div class="form-group col-md-6">
                    <label for="trade">Trade</label>
                    <input type="text" class="form-control" id="trade" name="trade" value="{$coins['trade']|default:''}">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="commission" name="commission" value="{$coins['commission']|default:''}">
                </div>
                <div class="form-group col-md-6">
                    <label for="chart">Chart</label>
                    <input type="text" class="form-control" id="chart" name="chart" value="{$coins['chart']|default:''}">
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="orderbl" name="orderbl" value="{$coins['orderbl']|default:''}">
                </div>
				
				<div class="form-group col-md-6">
					<label for="ema">Ema</label>
					<input type="text" class="form-control" id="ema" name="ema" value="{$coins['ema']|default:''}">
				</div>
			</div> 
			...
			<div class="form-row">
				<div class="form-group col-md-6">
					...
					<input type="text" class="form-control" id="qqe_mod" name="qqe_mod" value="{$coins['qqe_mod']|default:''}">
				</div>

				<div class="form-group col-md-6">
					<label for="trend-meter">Trend Meter</label>
					<input class="form-control" list="trendMeterOptions" id="trend_meter" name="trend_meter" value="{$coins['trend_meter']|default:''}">
            ...
            <div class="form-group">
				...
				<textarea class="form-control" id="bemerkung" name="bemerkung" rows="3">{$coins['bemerkung']|default:''}</textarea>
			</div>
